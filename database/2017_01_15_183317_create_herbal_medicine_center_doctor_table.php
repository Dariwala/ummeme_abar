...
class CreateHerbalMedicineCenterDoctorTable extends Migration
{
    public function up()
    {
        Schema::create('harbal_center_doctor', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
       Schema::dropIfExists('harbal_center_doctor');
    }
}
