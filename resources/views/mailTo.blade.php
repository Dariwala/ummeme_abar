 ...
 <table class="table"> 
     ...
     <tr>
      ...
      <tr> 
          ...
          <td>:</td>
          <td style=" width:70%">{{ $data1['home_delivary_minumum_ord'] }}<br></td>
     </tr>
     <tr> 
          <td style=" width:30%">Service Area <br></td>
          <td>:</td>
          <td style=" width:70%">{{$data1['home_delivary_service_area']}} </td>
     </tr>
      <tr> 
          <td style=" width:30%">Delivery Charge  <br></td>
          <td>:</td>
          <td style=" width:70%">{{$data1['home_delivary_delivery_charge']}} </td>
     </tr>
     <tr> 
     ...
     <tr> 
          <td style=" width:30%">Service Hour  <br></td>
          <td>:</td>
          <td style=" width:70%">{{$data1['home_delivary_service_hour']}}</td>
     </tr>
     <tr> 
          <td style=" width:30%">Working Day <br></td>
          <td>:</td>
          <td style=" width:70%"> {{$data1['home_delivary_working_day']}}</td>
     </tr>
     <tr> 
          <td style=" width:30%">Closed  <br></td>
          <td>:</td>
          <td style=" width:70%">{{$data1['home_delivary_close']}} </td>
     </tr>
     <tr> 
          <td style=" width:30%">Contact Number <br></td>
          <td>:</td>
          <td style=" width:70%">{{$data1['home_delivary_contuct_number']}} </td>
     </tr>
     <tr>
     ...
     <tr> 
          ...
          <td>:</td>
          <td style=" width:70%">{{$data1['home_delivary_service_charge']}}</td>
     </tr>
      <tr> 
