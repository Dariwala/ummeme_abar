...
{!! csrf_field() !!}
<input type="hidden" name="subject" value="Beauty Parlour and Spa"/>
...
@else  
    ...
    <p style="font-size: 18px;font-weight: bold;background:white;color:black; text-align:left">Service </p>
    <div class="uk-grid" data-uk-grid-margin>
        <div class="uk-width-medium-1-1">
            <div class="parsley-row">
                <label for="message">
