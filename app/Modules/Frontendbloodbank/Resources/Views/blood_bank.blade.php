            ...
            <div class="user_content" style="position:relative;z-index:1;">
                ...
                <ul class="uk-switcher uk-margin" id="user_profile_tabs_content">
                                ...
                                <ul class="md-list md-list-addon">
                                    ...
                                    <li>
                                        ...
                                        <div class="md-list-content">
                                            ...
                                            <span style="margin-top:5px"  class="md-list-heading">
                                                {{$blood_bank->blood_bank_email_ad}}<a href = "mailto:{{$blood_bank->blood_bank_email_ad}}" style="color:black;"><i class="fa fa-envelope" style="margin-left:6px;"></i></a>
                                            </span>
                    ...
                    <li ng-controller="ViewBloodBankController">
                        ...
                        <div   class="uk-form-row">
                        <select class="md-input selectable" id="service_id" name="service_id" ng-model="service_id" ng-change="getBloodBankService()"    style="width: 100%;"></select>
                        </div>
