        ...
        <div class="md-card">
            <div class="user_heading">
                ...
                <div class="user_heading_content" style="display:table;margin:0 auto;">
                    <h2 class="heading_b"><span class="uk-text-break">{{$ambulance->b_ambulance_name}}</span>
                    </h2>
                </div>
            </div>
                ...
                <ul class="uk-switcher uk-margin" id="user_profile_tabs_content">
                    <li><?php echo $ambulance->b_ambulance_description; ?>
                                ...
                                <ul class="md-list md-list-addon">
                                    ...
                                    <li>
                                        ...
                                        <div class="md-list-content">
                                            ...
                                            @if($ambulance->b_ambulance_phone != '')
                                                @php
                                                    $phone_number_splitted = explode("\n",$ambulance->b_ambulance_phone);
                                    ...
                                    <li>
                                        ...
                                        <div class="md-list-content">
                                              <span style="margin-top:5px"  class="md-list-heading">
                                                {{$ambulance->ambulance_email}}<a href = "mailto:{{$ambulance->ambulance_email}}" style="color:black;"><i class="fa fa-envelope" style="margin-left:5px;"></i></a>
                                              </span>
                        ...
                        <div class="uk-width-large-1-1 uk-margin-medium-top">
                            ...
                            <?php echo $ambulance->b_total_ambulance; ?>
                            <!--
                    ...
                    <li>
                        <ul class="md-list">
                            ...
                            <?php echo $notice->b_ambulance_notice_description; ?>
                            <!--
                            <li>
    ...
    @else
        ...
        <div class="md-card">
            <div class="user_heading">
                ...
                <div class="user_heading_content" style="display:table;margin:0 auto;">
                    <h2 class="heading_b"><span class="uk-text-break">{{$ambulance->ambulance_name}}</span>
                    </h2>
                </div>
            </div>
                ...
                <ul class="uk-switcher uk-margin" id="user_profile_tabs_content">
                    <li><?php echo $ambulance->ambulance_description; ?>
                        ...
                        <div class="uk-width-large-1-1 uk-margin-medium-top">
                            ...
                            <?php echo $ambulance->total_ambulance; ?>
                            <!--
                            <ul class="md-list uk-margin-small-top">
                                <li>
                                    <div class="md-list-content">
                    ...
                    <li>
                        <ul class="md-list">
                            @foreach( $notices as $notice )
                            <?php echo $notice->ambulance_notice_description; ?>
                            <!--
