            ...
            <div class="user_content" style="position:relative;z-index:1;">
                ...
                <ul class="uk-switcher uk-margin" id="user_profile_tabs_content">
                                ...
                                <ul class="md-list md-list-addon">
                                    ...
                                    <li>
                                        ...
                                        <div class="md-list-content">
                                            ...
                                            <span style="margin-top:5px" class="md-list-heading">{{$skin_laser_center->skin_laser_center_email_ad}}<a href = "mailto:{{$skin_laser_center->skin_laser_center_email_ad}}" style="color:black;"><i class="fa fa-envelope" style="margin-left:6px;"></i></a></span>
                    ...
                    <li ng-controller="ViewSkinLaserCenterController">
                        ...
                        <div   class="uk-form-row">
                        <select class="md-input selectable" id="service_id" name="service_id" ng-model="service_id" ng-change="getSkinLaserCenterService()"    style="width: 100%;"></select>
                        </div>
                                ...
                                <ul class="md-list md-list-addon">
                                    ...
                                    <li>
                                        ...
                                        <div class="md-list-content">
                                            ...
                                            <span style="margin-top:5px" class="md-list-heading">
                                                {{$skin_laser_center->skin_laser_center_email_ad}}<a href = "mailto:{{$skin_laser_center->skin_laser_center_email_ad}}" style="color:black;"><i class="fa fa-envelope" style="margin-left:6px;"></i></a>
                                            </span>
