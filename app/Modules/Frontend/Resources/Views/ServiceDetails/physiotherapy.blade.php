            ...
            <div class="md-card">
                <div class="user_heading">
                    ...
                    <div class="user_heading_content" style="display:table;margin:0 auto;">
                        <h2 class="heading_b"><span class="uk-text-break">{{$physiotherapy->physiotherapy_name}}</span>
                        </h2>
                    </div>
                </div>
                    ...
                    <ul class="uk-switcher uk-margin" id="user_profile_tabs_content">
                        <li><?php echo $physiotherapy->physiotherapy_description; ?>
                            ...
                            <!--<div class="uk-grid" data-uk-grid-margin="">
                                <div class="uk-width-large-1-1">
                                    ...
                                    <ul class="md-list md-list-addon">
                                        ...
                                        <li>
                                            ...
                                            <div class="md-list-content">
                                                <span style="margin-top:5px"  class="md-list-heading">
                                                    @if($physiotherapy->physiotherapy_phone_no != '')
                                                    @php
                                                        $e_phone_number_splitted = explode("\n",$physiotherapy->physiotherapy_phone_no);
                                        ...
                                        @if($physiotherapy->physiotherapy_email_ad != '')
                                        <li>
                                            <div class="md-list-addon-element">
                                            ...
                                            <div class="md-list-content">
                                                <span style="margin-top:5px" class="md-list-heading">{{$physiotherapy->physiotherapy_email_ad}}<a href = "mailto:{{$physiotherapy->physiotherapy_email_ad}}" style="color:black;"><i class="fa fa-envelope" style="margin-left:6px;"></i></a></span>
                            ...
                            <div class="uk-width-large-1-1 uk-margin-medium-top">
                                ...
                                <?php #echo  $physiotherapy->total_medicine; ; ?>
                                    <li>
                                        <div class="md-list-content">
                            ...
                            @if( $physiotherapy->physiotherapy_latitude != '' && $physiotherapy->physiotherapy_longitude != '' )
                        ...
                        <li>
                            ...
                            @foreach($notices as $notice)
                                <?php echo $notice->physiotherapy_notice_description; ?>
                            @endforeach
                            <!--
                        ...
                        <li>
                            <ul class="md-list">
                                ...
                                <?php echo $product->physiotherapy_product_description; ?>
                                <!--
                                <li style="padding-top: 0px;">
                                    <div class="md-list-content">
    ...
    <div class="uk-width-large-7-10" oncopy="return false" oncut="return false" onpaste="return false">
            <div class="md-card">
                <div class="user_heading">
                    ...
                    <div class="user_heading_content" style="display:table;margin:0 auto;">
                        <h2 class="heading_b"><span class="uk-text-break">{{$physiotherapy->b_physiotherapy_name}}</span>
                        </h2>
                    </div>
                </div>
                    ...
                    <ul class="uk-switcher uk-margin" id="user_profile_tabs_content">
                        <li><?php echo $physiotherapy->b_physiotherapy_description; ?>
                                ...
                                <div class="uk-width-large-1-1">
                                    ...
                                    <ul class="md-list md-list-addon">
                                        ...
                                        <li>
                                            ...
                                            <div class="md-list-content">
                                                <span style="margin-top:5px"  class="md-list-heading">
                                                    @if($physiotherapy->b_physiotherapy_phone_no != '')
                                                    @php
                                                        $phone_number_splitted = explode("\n",$physiotherapy->b_physiotherapy_phone_no);
                                                        $e_phone_number_splitted = explode("\n",$physiotherapy->physiotherapy_phone_no);
                                        ...
                                        <li>
                                            ...
                                            <div class="md-list-content">
                                                <span style="margin-top:5px" class="md-list-heading">
                                                    {{$physiotherapy->physiotherapy_email_ad}}<a href = "mailto:{{$physiotherapy->physiotherapy_email_ad}}"><i class="fa fa-envelope" style="margin-left:6px;"></i></a>
                                                </span>
                            ...
                            <div class="uk-width-large-1-1 uk-margin-medium-top">
                                ...
                                <ul class="md-list uk-margin-small-top">
                                <?php #echo  $physiotherapy->b_total_medicine; ; ?>
                                    <li>
                                        <div class="md-list-content">
                        ...
                        <li>
                            <ul class="md-list">
                            @foreach($notices as $notice)
                            <?php echo $notice->b_physiotherapy_notice_description; ?>
                            @endforeach
                            <!--
                                <li style="padding-top: 0px;">
                                    <div class="md-list-content">
                            ...
                            <ul class="md-list uk-margin-top">
                                <li ng-repeat = "doctor in doctors" style = "padding-top: 0px;">
                                    <div class="md-list-content">
                                        ...
                                        <a href="{{'/'}}frontendmedicalspecialist/view/@{{doctor.id}}/{{$physiotherapy->subdistrict_id}}"><h4 style="color:red;padding-top:10px;" class=" uk-margin-small-bottom">বিস্তারিত দেখুন</h4></a>
                                    </div>
                                </li>
                            </ul>
                        </li>
                        <li>
                            <ul class="md-list">
                                @foreach($products as $product)
                                <?php echo $product->b_physiotherapy_product_description; ?>
                                <!--
                                <li style="padding-top: 0px;">
                                    <div class="md-list-content">
