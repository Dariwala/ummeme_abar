            ...
            <div class="md-card">
                <div class="user_heading">
                    ...
                    <div class="user_heading_content" style="display:table;margin:0 auto;">
                        <h2 class="heading_b"><span class="uk-text-break">{{$optical->optical_name}}</span>
                        </h2>
                    </div>
                </div>
                    ...
                    <ul class="uk-switcher uk-margin" id="user_profile_tabs_content">
                        <li><?php echo $optical->optical_description; ?>
                                ...
                                <div class="uk-width-large-1-1">
                                    ...
                                    <ul class="md-list md-list-addon">
                                        ...
                                        <li>
                                            ...
                                            <div class="md-list-content">
                                                <span style="margin-top:5px"  class="md-list-heading">
                                                    @if($optical->optical_phone_no != '')
                                                    @php
                                                        $e_phone_number_splitted = explode("\n",$optical->optical_phone_no);
                                        ...
                                        <li>
                                            ...
                                            <div class="md-list-content">
                                                <span style="margin-top:5px" class="md-list-heading">{{$optical->optical_email_ad}}<a href = "mailto:{{$optical->optical_email_ad}}" style="color:black;"><i class="fa fa-envelope" style="margin-left:6px;"></i></a></span>
                            ...
                            <div class="uk-width-large-1-1 uk-margin-medium-top">
                                ...
                                <?php #echo  $optical->total_medicine; ; ?>
                            ...
                            @if( $optical->optical_latitude != '' && $optical->optical_longitude != '' )
                        ...
                        <li>
                            ...
                            @foreach($notices as $notice)
                                <?php echo $notice->optical_notice_description; ?>
                            @endforeach
                            <!--
                        ...
                        <li>
                            <ul class="md-list">
                                ...
                                <?php echo $product->optical_product_description; ?>
                                <!--
                                <li style="padding-top: 0px;">
                                    <div class="md-list-content">
    ...
    <div class="uk-width-large-7-10" oncopy="return false" oncut="return false" onpaste="return false">
            <div class="md-card">
                <div class="user_heading">
                    ...
                    <div class="user_heading_content" style="display:table;margin:0 auto;">
                        <h2 class="heading_b"><span class="uk-text-break">{{$optical->b_optical_name}}</span>
                        </h2>
                    </div>
                </div>
                    ...
                    <ul class="uk-switcher uk-margin" id="user_profile_tabs_content">
                        <li><?php echo $optical->b_optical_description; ?>
                                ...
                                <div class="uk-width-large-1-1">
                                    ...
                                    <ul class="md-list md-list-addon">
                                        ...
                                        <li>
                                            ...
                                            <div class="md-list-content">
                                                <span style="margin-top:5px"  class="md-list-heading">
                                                    @if($optical->b_optical_phone_no != '')
                                                    @php
                                                        $phone_number_splitted = explode("\n",$optical->b_optical_phone_no);
                                                        $e_phone_number_splitted = explode("\n",$optical->optical_phone_no);
                                        ...
                                        <li>
                                            ...
                                            <div class="md-list-content">
                                                <span style="margin-top:5px" class="md-list-heading">
                                                    {{$optical->optical_email_ad}}<a href = "mailto:{{$optical->optical_email_ad}}" style="color:black;"><i class="fa fa-envelope" style="margin-left:6px;"></i></a>
                                                </span>
                            ...
                            <div class="uk-width-large-1-1 uk-margin-medium-top">
                                ...
                                <ul class="md-list uk-margin-small-top">
                                <?php #echo  $optical->b_total_medicine; ; ?>
                        ...
                        <li>
                            <ul class="md-list">
                            @foreach($notices as $notice)
                            <?php echo $notice->b_optical_notice_description; ?>
                            @endforeach
                            <!--
                                <li style="padding-top: 0px;">
                                    <div class="md-list-content">
                        ...
                        <li ng-controller="ViewBnOpticalController">
                            <input type="hidden" ng-init="optical_id='asdfg'" value="{{$optical_id}}" name="optical_id" ng-model="optical_id">
                            <div class="uk-form-row" style="position:relative;z-index:12;">
                            <select class="md-input selectable" id="department_id" name="department_id" ng-model="department_id" ng-change="getMedicalSpecialist()" style="width: 100%;"></select>
                            </div>
                            <div class="uk-form-row">
                            <select class="md-input selectable" id="medical_specialist_id" name="medical_specialist_id" ng-model="medical_specialist_id" ng-change="getDoctor()"  style="width: 100%;"></select>
                            ...
                            <ul class="md-list uk-margin-top">
                                <li ng-repeat = "doctor in doctors" style = "padding-top: 0px;">
                                    <div class="md-list-content">
                                        ...
                                        <a href="{{'/'}}frontendmedicalspecialist/view/@{{doctor.id}}/{{$optical->subdistrict_id}}"><h4 style="color:red;padding-top:10px;" class=" uk-margin-small-bottom">বিস্তারিত দেখুন</h4></a>
                                    </div>
                                </li>
                            </ul>
                        </li>
