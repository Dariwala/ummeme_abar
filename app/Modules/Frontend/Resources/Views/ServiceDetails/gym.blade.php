            ...
            <div class="md-card">
                <div class="user_heading">
                    ...
                    <div class="user_heading_content" style="display:table;margin:0 auto;">
                        <h2 class="heading_b"><span class="uk-text-break">{{$gym->b_gym_name}}</span>
                        </h2>
                    </div>
                </div>
                ...
                <div class="user_content">
                    ...
                    <ul class="uk-switcher uk-margin" id="user_profile_tabs_content">
                        <li><?php echo $gym->b_gym_description; ?>
                                ...
                                <div class="uk-width-large-1-1">
                                    ...
                                    <ul class="md-list md-list-addon">
                                        ...
                                        <li>
                                            ...
                                            <div class="md-list-content">
                                                <span style="margin-top:5px" class="md-list-heading ">
                                                    {{$gym->gym_email_ad}}<a href = "mailto:{{$gym->gym_email_ad}}" style="color:black;"><i class="fa fa-envelope" style="margin-left:1px;"></i></a>
                                                </span>
                            ...
                            @if( $gym->gym_latitude != '' && $gym->gym_longitude != '' )
                        ...
                        <li>
                            <ul class="md-list">
                                ...
                                <?php echo $notice->b_gym_notice_description; ?>
                                <!--
        ...
        <div class="uk-width-large-7-10" oncopy="return false" oncut="return false" onpaste="return false">
            <div class="md-card">
                <div class="user_heading">
                    ...
                    <div class="user_heading_content" style="display:table;margin:0 auto;">
                        <h2 class="heading_b"><span class="uk-text-break">{{$gym->gym_name}}</span>
                        </h2>
                    </div>
                </div>
                ...
                <div class="user_content">
                    ...
                    <ul class="uk-switcher uk-margin" id="user_profile_tabs_content">
                                ...
                                <div class="uk-width-large-1-1">
                                    ...
                                    <ul class="md-list md-list-addon">
                                        ...
                                        <li>
                                            ...
                                            <div class="md-list-content">
                                                <span style="margin-top:5px" class="md-list-heading ">{{$gym->gym_email_ad}}<a href = "mailto:{{$gym->gym_email_ad}}" style="color:black;"><i class="fa fa-envelope" style="margin-left:1px;"></i></a></span>
                        ...
                        <li>
                            <ul class="md-list">
                                @foreach($notices as $notice)
                                <?php echo $notice->gym_notice_description; ?>
                                <!--
                                <li style="padding-top: 0px;">
                                    <div class="md-list-content">
