                                ...
                                <div class="uk-width-large-1-1">
                                    ...
                                    <ul class="md-list md-list-addon">
                                        ...
                                        <li>
                                            ...
                                            <div class="md-list-content">
                                                <span style="margin-top:5px" class="md-list-heading ">
                                                    {{$gym->gym_email_ad}}<a href = "mailto:{{$gym->gym_email_ad}}" style="color:black;"><i class="fa fa-envelope" style="margin-left:6px;"></i></a>
                                                </span>
                                ...
                                <div class="uk-width-large-1-1">
                                    ...
                                    <ul class="md-list md-list-addon">
                                        ...
                                        <li>
                                            ...
                                            <div class="md-list-content">
                                                <span style="margin-top:5px" class="md-list-heading ">{{$gym->gym_email_ad}}<a href = "mailto:{{$gym->gym_email_ad}}" style="color:black;"><i class="fa fa-envelope" style="margin-left:6px;"></i></a></span>
