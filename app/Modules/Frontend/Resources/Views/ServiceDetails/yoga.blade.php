            ...
            <div class="md-card">
                <div class="user_heading">
                    ...
                    <div class="user_heading_content" style="display:table;margin:0 auto;">
                        <h2 class="heading_b"><span class="uk-text-break">{{$yoga->b_yoga_name}}</span>
                        </h2>
                    </div>
                </div>
                    ...
                    <ul class="uk-switcher uk-margin" id="user_profile_tabs_content">
                        <li><?php echo $yoga->b_yoga_description; ?>
                                ...
                                <div class="uk-width-large-1-1">
                                    ...
                                    <ul class="md-list md-list-addon">
                                        ...
                                        <li>
                                            ...
                                            <div class="md-list-content">
                                                <span style="margin-top:5px" class="md-list-heading">
                                                    @if($yoga->b_yoga_phone_no != '')
                                                    @php
                                                        $phone_number_splitted = explode("\n",$yoga->b_yoga_phone_no);
                                        ...
                                        <li>
                                            ...
                                            <div class="md-list-content">
                                                <span style="margin-top:5px" class="md-list-heading ">
                                                    {{$yoga->yoga_email_ad}}<a href = "mailto:{{$yoga->yoga_email_ad}}" style="color:black;"><i class="fa fa-envelope" style="margin-left:1px;"></i></a>
                                                </span>
                            ...
                            <div class="uk-width-large-1-1 uk-margin-medium-top">
                                ...
                                <?php echo $yoga->b_yoga_total_bed; ?>
                                <!--
                                    <li>
                                        <div class="md-list-content">
                            ...
                            @if( $yoga->yoga_latitude != '' && $yoga->yoga_longitude != '' )
                        ...
                        <li>
                            <ul class="md-list">
                                ...
                                <?php echo $notice->b_yoga_notice_description; ?>
                                <!--
                        ...
                        <li ng-controller="ViewBnYogaController">
                            ...
                            <select class="md-input selectable" id="service_id" name="service_id" ng-model="service_id" ng-change="getYogaService()"   style="width: 100%;"></select>
                            </div>
        ...
        <div class="uk-width-large-7-10" oncopy="return false" oncut="return false" onpaste="return false">
            <div class="md-card">
                <div class="user_heading">
                    ...
                    <div class="user_heading_content" style="display:table;margin:0 auto;">
                        <h2 class="heading_b"><span class="uk-text-break">{{$yoga->yoga_name}}</span>
                        </h2>
                    </div>
                </div>
                ...
                <div class="user_content">
                    ...
                    <ul class="uk-switcher uk-margin" id="user_profile_tabs_content">
                                ...
                                <div class="uk-width-large-1-1">
                                    ...
                                    <ul class="md-list md-list-addon">
                                        ...
                                        <li>
                                            ...
                                            <div class="md-list-content">
                                                <span style="margin-top:5px" class="md-list-heading ">{{$yoga->yoga_email_ad}}<a href = "mailto:{{$yoga->yoga_email_ad}}" style="color:black;"><i class="fa fa-envelope" style="margin-left:1px;"></i></a></span>
                        ...
                        <li>
                            <ul class="md-list">
                                @foreach($notices as $notice)
                                <?php echo $notice->yoga_notice_description; ?>
                                <!--
                                <li style="padding-top: 0px;">
                                    <div class="md-list-content">
                        ...
                        <li ng-controller="ViewYogaController">
                            <input type="hidden" ng-init="yoga_id='asdfg'" value="{{$yoga_id}}" name="yoga_id" ng-model="yoga_id">
                            <div   class="uk-form-row">
                            <select class="md-input selectable"t id="service_id" name="service_id" ng-model="service_id" ng-change="getYogaService()"   style="width: 100%;"></select>
                            </div>
