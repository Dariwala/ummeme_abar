                                ...
                                <div class="uk-width-large-1-1">
                                    ...
                                    <ul class="md-list md-list-addon">
                                        ...
                                        <li>
                                            ...
                                            <div class="md-list-content">
                                                <span style="margin-top:5px" class="md-list-heading ">
                                                    {{$yoga->yoga_email_ad}}<a href = "mailto:{{$yoga->yoga_email_ad}}"><i class="fa fa-envelope-o" style="margin-left:5px;"></i></a>
                                                </span>
                                ...
                                <div class="uk-width-large-1-1">
                                    ...
                                    <ul class="md-list md-list-addon">
                                        ...
                                        <li>
                                            ...
                                            <div class="md-list-content">
                                                <span style="margin-top:5px" class="md-list-heading ">{{$yoga->yoga_email_ad}}<a href = "mailto:{{$yoga->yoga_email_ad}}"><i class="fa fa-envelope-o" style="margin-left:5px;"></i></a></span>
