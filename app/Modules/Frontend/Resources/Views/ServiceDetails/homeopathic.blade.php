                ...
                <div class="user_content" style="position:relative;z-index:1;">
                    ...
                    <ul class="uk-switcher uk-margin" id="user_profile_tabs_content">
                                ...
                                <div class="uk-width-large-1-1">
                                    ...
                                    <ul class="md-list md-list-addon">
                                        ...
                                        <li>
                                            ...
                                            <div class="md-list-content">
                                                <span style="margin-top:5px" class="md-list-heading">{{$homeopathic->homeopathic_email_ad}}<a href = "mailto:{{$homeopathic->homeopathic_email_ad}}" style="color:black;"><i class="fa fa-envelope" style="margin-left:6px;"></i></a></span>
                        ...
                        <li ng-controller="ViewHomeopathicController">
                            <input type="hidden" ng-init="homeopathic_id='asdfg'" value="{{ $homeopathic_id }}" name="homeopathic_id" ng-model="homeopathic_id">
                            <div class="uk-form-row">
                            <select class="md-input selectable" id="service_id" name="service_id" ng-model="service_id" ng-change="getHomeopathicService()" style="width: 100%;"></select>
                            </div>
                                ...
                                <div class="uk-width-large-1-1">
                                    ...
                                    <ul class="md-list md-list-addon">
                                        ...
                                        <li>
                                            ...
                                            <div class="md-list-content">
                                                <span style="margin-top:5px" class="md-list-heading">
                                                    {{$homeopathic->homeopathic_email_ad}}<a href = "mailto:{{$homeopathic->homeopathic_email_ad}}" style="color:black;"><i class="fa fa-envelope" style="margin-left:6px;"></i></a>
                                                </span>
                            ...
                            <ul class="md-list uk-margin-top">
                                <li ng-repeat = "doctor in doctors" style = "padding-top: 0px;">
                                    <div class="md-list-content">
                                        ...
                                        <a href="{{'/'}}frontendmedicalspecialist/view/@{{doctor.id}}/{{$homeopathic->subdistrict_id}}"><h4 style="color:red;padding-top:10px;" class=" uk-margin-small-bottom">বিস্তারিত দেখুন</h4></a>
                                    </div>
                                </li>
                            </ul>
                        </li>
