                                ...
                                <ul class="md-list uk-margin-top">
                                    <li ng-repeat = "doctor in doctors" style = "padding-top: 0px;">
                                        <div class="md-list-content">
                                            ...
                                            <a href="{{'/'}}frontendmedicalspecialist/view/@{{doctor.id}}/{{$addiction->subdistrict_id}}"><h4 style="color:red;padding-top:10px;" class=" uk-margin-small-bottom">বিস্তারিত দেখুন</h4></a>
                                        </div>
                                    </li>
                                </ul>
                            </li>
