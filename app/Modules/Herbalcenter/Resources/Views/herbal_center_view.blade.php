...
@section('angular')
    ...
    <script src="{{url('app/admin/herbal_center/herbal_center.view.js')}}"></script>
@endsection
                    ...
                    <div class="md-card">
                        ...
                        <div class="user_content">
                            <ul class="uk-tab" data-uk-sticky="{ top: 48, media: 960 }" data-uk-tab="{connect:'#user_profile_tabs_content', animation:'slide-horizontal'}" id="user_profile_tabs">
                                ...
                                <li ng-controller="ViewHerbalCenterController">
                                    <a style="text-align:left" ng-click="getproductSubCategoryDropDown()" href="#">Medicinal</a>
                                </li>
                            ...
                            <ul class="uk-switcher uk-margin" id="user_profile_tabs_content">
                                <li><?php echo $herbal_center->herbal_center_description; ?>
                                    ...
                                    <div class="uk-margin uk-margin-large-bottom" data-uk-grid-margin="">
                                        <div class="uk-width-large-1-1">
                                            ...
                                            <ul class="md-list uk-margin-small-top">
                                                <li>
                                                    <div class="md-list-content">
                                                        <span class="hidden">General :</span> <span><?php echo $herbal_center->herbal_center_total_bed; ?></ ?></span>
                                                    </div>
                                                </li>
                                            </ul>  
                                        </div>
                                    ...
                                    <div class="uk-width-large-1-1 google_maps_show">
                                         <iframe 
                                            src="https://www.google.com/maps/embed/v1/search?key=AIzaSyD3_tCn50Ef5Z2zUJxkXi26T486gIzIHp8&q={{ $herbal_center->herbal_center_latitude }}, {{ $herbal_center->herbal_center_longitude }}" frameborder="0" height="600" style="border:0; width:100%;" allowfullscreen>
                                        </iframe>
                                    </div>
                                    <!-- END google maps -->
                                    ...
                                    <ul class="md-list uk-margin-top">
                                        <li ng-repeat = "doctor in doctors" style = "padding-top: 0px;">
                                            <div class="md-list-content">
                                                ...
                                                <a href="{{'/'}}frontendmedicalspecialist/view/@{{doctor.id}}/{{$herbal_center->subdistrict_id}}"><h4 style="color:red;" class=" uk-margin-small-bottom">View Details</h4></a>
                                            </div>
                                        </li>
                                    </ul>
                                </li>
