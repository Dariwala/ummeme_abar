            ...
            <div  class="user_content" style="position:relative;z-index:1;">
                ...
                <ul class="uk-switcher uk-margin" id="user_profile_tabs_content">
                            ...
                            <div class="uk-width-large-1-1">
                                ...
                                <ul class="md-list md-list-addon">
                                    ...
                                    <li>
                                        ...
                                        <div class="md-list-content">
                                            <span style="margin-top:5px" class="md-list-heading ">
                                                {{$hospital->hospital_email_ad}}<a href = "mailto:{{$hospital->hospital_email_ad}}" style="color:black;"><i class="fa fa-envelope" style="margin-left:6px;"></i></a>
                                            </span>
                    ...
                    <li ng-controller="ViewHospitalController">
                        ...
                        <div   class="uk-form-row">
                        <select class="md-input selectable" id="service_id" name="service_id" ng-model="service_id" ng-change="getHospitalService()"    style="width: 100%;"></select>
                        </div>
