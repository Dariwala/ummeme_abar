...
@section('angular')
    ...
    <script src="{{url('app/admin/physiotherapy/physiotherapy.view.js')}}"></script>
@endsection
                                ...
                                <li><?php echo $physiotherapy->physiotherapy_description; ?>
                                    ...
                                    <!-- START google maps -->
                                        <div class="uk-width-large-1-1 google_maps_show">
                                             <iframe 
                                                src="https://www.google.com/maps/embed/v1/search?key=AIzaSyD3_tCn50Ef5Z2zUJxkXi26T486gIzIHp8&q={{ $physiotherapy->physiotherapy_latitude }}, {{ $physiotherapy->physiotherapy_longitude }}" frameborder="0" height="600" style="border:0; width:100%;" allowfullscreen>
                                            </iframe>
                                        </div>
                                    <!-- END google maps -->
