...
@section('angular')
    ...
    <script src="{{url('app/admin/hospital/hospital.view.js')}}"></script>
@endsection
                            ...
                            <ul class="uk-switcher uk-margin" id="user_profile_tabs_content">
                                <li><?php echo $hospital->hospital_description; ?>
                                    ...
                                    <div class="uk-width-large-1-1 google_maps_show">
                                         <iframe 
                                            src="https://www.google.com/maps/embed/v1/search?key=AIzaSyD3_tCn50Ef5Z2zUJxkXi26T486gIzIHp8&q={{ $hospital->hospital_latitude }}, {{ $hospital->hospital_longitude }}" frameborder="0" height="600" style="border:0; width:100%;" allowfullscreen>
                                        </iframe>
                                    </div>
                                    <!-- END google maps -->
                                    ...
                                    <ul class="md-list uk-margin-top">
                                        <li ng-repeat = "doctor in doctors" style = "padding-top: 0px;">
                                            <div class="md-list-content">
                                                ...
                                                <a href="{{'/'}}frontendmedicalspecialist/view/@{{doctor.id}}/{{$hospital->subdistrict_id}}"><h4 style="color:red;" class=" uk-margin-small-bottom">View Details</h4></a>
                                            </div>
                                        </li>
                                    </ul>
                                </li>
                                <li ng-controller="ViewHospitalController">
                                    ...
                                    <ul class="md-list">
                                        <li ng-repeat = "service in services">
                                            <div class="md-list-content">
                                                <h4 class="heading_c">@{{service.hospital_service_title}}</h4>
                                                <div>
