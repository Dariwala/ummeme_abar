...
@section('angular')
    ...
    <script src="{{url('app/admin/parlour/parlour.view.js')}}"></script>
@endsection
                            ...
                            <ul class="uk-switcher uk-margin" id="user_profile_tabs_content">
                                <li><?php echo $parlour->parlour_description; ?>
                                    ...
                                    <div class="uk-width-large-1-1 google_maps_show">
                                         <iframe 
                                            src="https://www.google.com/maps/embed/v1/search?key=AIzaSyD3_tCn50Ef5Z2zUJxkXi26T486gIzIHp8&q={{ $parlour->parlour_latitude }}, {{ $parlour->parlour_longitude }}" frameborder="0" height="600" style="border:0; width:100%;" allowfullscreen>
                                        </iframe>
                                    </div>
                                    <!-- END google maps -->
