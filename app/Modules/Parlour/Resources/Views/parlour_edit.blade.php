                                        ...
                                        <input type="hidden" ng-init="parlour_id='asdfg'" value="{{$parlour_id}}" name="parlour_id" ng-model="parlour_id">
                                            ...
                                            <div class="uk-width-medium-1-2">
                                                <div class="parsley-row ">
                                                     <label for="add_publication_title">Beauty Parlour & Spa Image<span class="req"></span></label>
                                                </div>
                                                <div class="parsley-row uk-margin-top">
                                ...
                                <li ng-controller="ParlourController">
                                    {!! Form::open(['url' => array('parlour/edit/about', $parlour->id), 'method' => 'POST', 'files' => true]) !!}
                                        <div class="uk-grid " data-uk-grid-margin>
                                            ...
                                            <div class="uk-width-medium-1-2">
                                                <label for="parlour_description">About</label>
                                                <div class="parsley-row uk-margin-top">
                                            ...
                                            <div class="uk-width-medium-1-2">
                                                <label for="b_parlour_description">সম্বন্ধে</label>
                                                <div class="parsley-row uk-margin-top">
                                            ...
                                            <div class="parsley-row uk-margin-top">
                                                    ...
                                                    <textarea class="md-input" id="parlour_address" name="parlour_address" cols="10" rows="3" data-parsley-trigger="keyup" onkeydown="expandtext(this);" >{{$parlour->parlour_address}}</textarea>
                                                </div>
                                            </div>
                                            <div class="uk-width-medium-1-2">
                                                <div class="parsley-row uk-margin-top">
                                                    <label for="b_parlour_address">ঠিকানা</label>
                                                    <textarea class="md-input" id="b_parlour_address" name="b_parlour_address" cols="10" rows="3" data-parsley-trigger="keyup" onkeydown="expandtext(this);" >{{$parlour->b_parlour_address}}</textarea>
                                                </div>
                                            </div>
                                            <div class="uk-width-medium-1-2">
                                                <div class="uk-grid uk-grid-medium form_section form_section_separator" data-uk-grid-match>
                                                    <div class="uk-width-10-10">
                                                        <div class="parsley-row uk-margin-top">
                                                            ...
                                                            <textarea class="md-input" id="parlour_phone_no" name="parlour_phone_no" cols="10" rows="3" data-parsley-trigger="keyup" onkeydown="expandtext(this);">{{$parlour->parlour_phone_no}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="uk-grid uk-grid-medium form_section form_section_separator" data-uk-grid-match>
                                                    <div class="uk-width-10-10">
                                                        <div class="parsley-row uk-margin-top">
                                                            ...
                                                            <textarea class="md-input" type="text" id="b_parlour_phone_no" name="b_parlour_phone_no" cols="10" rows="3" data-parsley-trigger="keyup" onkeydown="expandtext(this);" class="md-input">{{$parlour->b_parlour_phone_no}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="md-card">
                                            <div class="md-card-content">
                                                ...
                                                <div class="md-fab-wrapper Publication-create">
                                                    <a id="add_Publication_name_button" href="{{ url('parlour/edit/notice/add'.'/'.$parlour_id) }}"  class="md-fab Publication-create">
                                    ...
                                    {!! Form::open(['url' => array('parlour/edit/service', $parlour->id), 'method' => 'POST', 'files' => true]) !!}
                                        <div class="md-card">
                                            <div class="md-card-content">
                                                ...
                                                <div class="md-fab-wrapper Publication-create">
                                                    <a id="add_Publication_name_button" href="{{ url('parlour/edit/service/add'.'/'.$parlour_id) }}"  class="md-fab Publication-create">
                                                        <i class="material-icons" style="color:#FD0100">&#xE145;</i>
                                                    </a>
                                                </div>
                                            </div>
