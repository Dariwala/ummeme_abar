// blank controller
pharmacynew.controller('PharmacynewProductCategoryController', PharmacynewProductCategoryController);

function PharmacynewProductCategoryController($scope, $http) {
