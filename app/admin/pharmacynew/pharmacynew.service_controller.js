// Pharmacynew Service controller
blood_bank.controller('PharmacynewServiceController', PharmacynewServiceController);

function PharmacynewServiceController($scope, $http) {
