// blank controller
physiotherapy.controller('PhysiotherapyProductCategoryController', PhysiotherapyProductCategoryController);

function PhysiotherapyProductCategoryController($scope, $http) {
