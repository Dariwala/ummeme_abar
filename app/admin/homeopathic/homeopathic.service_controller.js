// Homeopathic Service controller
blood_bank.controller('HomeopathicServiceController', HomeopathicServiceController);

function HomeopathicServiceController($scope, $http) {
