// blank controller
homeopathic.controller('HomeopathicProductCategoryController', HomeopathicProductCategoryController);

function HomeopathicProductCategoryController($scope, $http) {
