// blank controller
herbal_center.controller('HerbalCenterProductEditController', HerbalCenterProductEditController);

function HerbalCenterProductEditController($scope, $http) {



    var herbal_center_product_id = document.getElementsByName('herbal_center_product_id')[0].value;
    

    $http
        .get(window.location.origin+"/product-category/api/herbal-center/get-selected-product-category/" + herbal_center_product_id, {
        ...
        $http
        .get(window.location.origin+"/product-category/api/herbal-center/get-selected-product-subcategory/" + herbal_center_product_id, {
            transformRequest: angular.identity,
            headers: {'Content-Type': undefined, 'Process-Data': false}
        })
        .then(function(response){
