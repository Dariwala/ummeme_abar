// Foreignmedical Service controller
blood_bank.controller('ForeignmedicalServiceController', ForeignmedicalServiceController);

function ForeignmedicalServiceController($scope, $http) {
