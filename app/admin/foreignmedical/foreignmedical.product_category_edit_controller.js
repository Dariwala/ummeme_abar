// blank controller
foreignmedical.controller('ForeignmedicalProductEditController', ForeignmedicalProductEditController);

function ForeignmedicalProductEditController($scope, $http) {



    var foreignmedical_product_id = document.getElementsByName('foreignmedical_product_id')[0].value;
    

    $http
        .get(window.location.origin+"/product-category/api/foreignmedical/get-selected-product-category/" + foreignmedical_product_id, {
        ...
        $http
        .get(window.location.origin+"/product-category/api/foreignmedical/get-selected-product-subcategory/" + foreignmedical_product_id, {
            transformRequest: angular.identity,
            headers: {'Content-Type': undefined, 'Process-Data': false}
        })
        .then(function(response){
